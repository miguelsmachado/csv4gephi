...
def main():
    ...
    st.markdown("Caso tenha alguma dúvida de como gerar esse arquivo, consulte o tutorial "
    ...
    if file is not None:
        ...
        bt_wordcloud_hashtags = st.button("Gerar Wordcloud de #")
        ...
        bt_loc_users = st.button("Encontrar usuários")
        if bt_loc_users:
        ...
        df_download = df[['source', 'target', 'url']]
